...
export default class Search extends Component {
    ...
    render() {
        ...
        return type === 'mobile' ? (
            <path
                fill={ color } d="M55.3,52.3L40.8,38c3.5-4,5.6-9.4,5.6-15C46.7,10.3,36.2,0,23.3,0S0,10.3,0,23s10.5,
                23,23.3,23c5.4,0,10.3-1.9,14.2-4.9L52,55.3c0.5,0.5,1.2,0.7,1.6,0.7c0.5,0,1.2-0.2,1.6-0.7C56.2,
                54.6,56.2,53.2,55.3,52.3z M4.7,23c0-10.1,8.4-18.3,18.7-18.3S42,12.9,42,23.2s-8.4,18.5-18.7,
                18.5S4.7,33.3,4.7,23z"
            />
        ) : (
            <g>
                <path
